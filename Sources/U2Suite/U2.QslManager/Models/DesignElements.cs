...
{
    public static class DesignElements
    {
        public const string Callsign = nameof(Callsign);
        public const string Qth = nameof(Qth);
        public const string Grid = nameof(Grid);
        public const string CqZone = nameof(CqZone);
        public const string ItuZone = nameof(ItuZone);
