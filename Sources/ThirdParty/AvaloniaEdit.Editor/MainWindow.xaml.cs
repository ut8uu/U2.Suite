...
namespace AvaloniaEdit.Editor
{
    ...
    public class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            Language language = _textMateInstallation.RegistryOptions.GetLanguageByExtension(".json");

            string scopeName = _textMateInstallation.RegistryOptions.GetScopeByLanguageId(language.Id);
